...
SuspensionShaft::SuspensionShaft(GLfloat point[3], GLfloat r, GLfloat w, GLfloat color[3]) : Solid(point, color), radius(r), width(w)
{
	this->colorSec[0] = color[0] + 0.1;
	this->colorSec[1] = color[1] + 0.1;
	this->colorSec[2] = color[2] + 0.1;
}


SuspensionShaft::~SuspensionShaft()
{
}

void SuspensionShaft::draw()
{
	glPushMatrix();
...
void SuspensionShaft::setColor(GLfloat color[3], GLfloat colorSec[3])
{
